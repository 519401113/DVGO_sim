...
#* Camera Settings
# 1cam 5 samples: start 20,
# 1cam 20 samples: start 14
# 1cam 7 samples: start 32
# 3cam 5 samples: start 20


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataroot', type=str, default = '/home/xieziyang/HDMap/Data/nuScenes/nuscenes_mini' )
    ...
    parser.add_argument('--first_sample_token', type=str, default='b5989651183643369174912bc5641d3b')
    parser.add_argument('--savedir', type=str, default='/home/xieziyang/HDMap/Data/nuScenes/nerf_data/parker')
