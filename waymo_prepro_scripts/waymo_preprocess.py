...
if __name__ == '__main__':
    ...
    default = '/SSD_DISK/users/chenyurui/waymo_scenes/0014075') # the file pathname  of data in kitti format
    parser.add_argument('--scene_name', type=str,
    default = '/SSD_DISK/users/chenyurui/processed_scenes/0014075')# the file pathname  of data in Snerf format
    parser.add_argument('--depthdir',type= str,
    default= '/SSD_DISK/users/chenyurui/waymo_scenes/0014075/final_data')# the file pathname  of depth data

    parser.add_argument('--img_num', type=int, default=100) # images num for every cam
